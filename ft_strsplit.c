...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/09 10:36:34 by lgarse            #+#    #+#             */
/*   Updated: 2019/09/15 18:00:05 by lgarse           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			**ft_strsplit(char const *s, char c)
{
	...
	if (!s || !(nline = ft_strdup((char *)s)))
		return (NULL);
	nwords = ft_get_words(nline, c, ft_count_words(nline, c));
	free(nline);
	return (nwords);
}
